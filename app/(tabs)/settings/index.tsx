...
export default function SettingsScreen() {
  const settingsData: SettingsItemProps[] = [
    ...
    { id: '4', title: 'Notification Reminder', description: "Set how many minutes before the activity should the reminder be sent on (e.g. activity is at 13:00, and the reminder is reminder is 5 minutes, so the notification will be sent at 12:55)", showSwitch: false},
